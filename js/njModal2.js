...
njm.show = function (opts) {
	...
	// if(o.position === 'absolute_inner' || o.position === 'absolute') {
		
	// 	this._getEnvironmentValues();
	// }

	// if(o.position === 'absolute' && o.close === 'outside') {
	// 		o.close = 'inside'
	// }
	

	if (o.hideScrollbar) {//should be before inserting overlay
	...
	//insert wrapper, if we use fixed position
	if(o.position === 'fixed' || o.position === 'absolute_inner') {
...
njm._scrollbar = function (type) {
	...
	case 'hide':
		if(this.v.prependTo[0] === this.v.b[0]) {
			...
			if(!this.v.b.hasClass('njm_hideScrollbar') && (sb || this.v.h.css('overflowY') === 'scroll' || this.v.b.css('overflowY') === 'scroll')) {
				this.v.b.css('paddingRight', parseInt(this.v.h.css('paddingRight')) + njModal.g.scrollbarSize + 'px');
			}
			this.v.b.addClass('njm_hideScrollbar');
		} else {
	...
	case 'show':
		if(this.v.prependTo[0] === this.v.b[0] && o.v.b.hasClass('njm_hideScrollbar')) {
				this.v.b.css('paddingRight', parseInt(this.v.b.css('paddingRight')) - njModal.g.scrollbarSize + 'px');
				this.v.b.removeClass('njm_hideScrollbar');
		} else {
